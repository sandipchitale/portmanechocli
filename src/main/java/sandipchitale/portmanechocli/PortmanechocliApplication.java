...
//	@Command(command = {"pe"}, description = "Access Postman Echo")
	@ShellComponent
	static class PostmanEchoCommand {
		private final RestClient restClient;

		PostmanEchoCommand(RestClient.Builder restClientBuilder) {
...
//		@Command(command = "put", description = "Access Postman Echo PUT")
		...
		public String put() {
			return restClient
					.put()
					.uri("/put")
					.contentType(MediaType.APPLICATION_FORM_URLENCODED).body("method=put")
					.retrieve()
					.body(String.class);
		}
